...
{
	CPPUNIT_ASSERT(noeud->obtenirType() == ArbreRenduINF2990::NOM_BONUS);
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudAbstraitTest::testEnregistrable()
///
/// Cas de test: s'assurer que le noeud est enregistrable dans le xml
///
/// @return Aucune.
///
////////////////////////////////////////////////////////////////////////
void NoeudAbstraitTest::testEnregistrable()
{
	// Cas 1 : non enregistrable
