...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudComposite::tuerPointsDeControle()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudComposite::tuerPointsDeControle()
{
	for (conteneur_enfants::iterator it{ enfants_.begin() };
		it != enfants_.end();) {
		if ((*it)->obtenirType() == "pointDeControle")
		{
			NoeudAbstrait* enfant{ (*it) };
			enfants_.erase(it);
			delete enfant;
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudComposite::afficherConcret(const glm::mat4& vueProjection, const bool& estColore) const
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudComposite::afficherConcret(const glm::mat4& vueProjection, const bool& estColore) const
{
	NoeudAbstrait::afficherConcret(vueProjection *transformationRelative_, estColore);

	for (NoeudAbstrait const* enfant : enfants_){
		enfant->afficher(vueProjection *transformationRelative_, estColore);
	}
}
...
//////////////////////////////////////////////////////////////////////////
/////
///// @fn void NoeudComposite::accepterVisi(VisiteurAbstrait* visiteur, bool estSelectionne)
/////
///// Cette fonction va permettre au noeud d'accepter un visiteur
/////
///// @param[in] visiteur : visiteur qui visite le noeud
///// @param[in] estSelectionne : verifie s'il y a selection des noeuds enfants
/////
///// @return Aucune.
/////
//////////////////////////////////////////////////////////////////////////
void NoeudComposite::accepterVisi(VisiteurAbstrait* visiteur, bool estSelectionne)
{
	for (unsigned int i = 0; i < obtenirNombreEnfants(); i++)
		enfants_[i]->accepter(visiteur);
}

void NoeudComposite::setCouleur()
{
	for (unsigned int i = 0; i < obtenirNombreEnfants(); i++)
	{
		enfants_[i]->setCouleurSel();
...
////////////////////////////////////////////////////////////////////////
///
/// @fn conteneur_enfants NoeudComposite::getEnfants()
///
/// Retourne les enfants du noeud composite
///
/// @return les enfants du conteneur d'enfants
///
////////////////////////////////////////////////////////////////////////
conteneur_enfants NoeudComposite::getEnfants()
{
	return enfants_;
}
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudComposite::tuerRondelle()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudComposite::tuerRondelle()
{
	for (conteneur_enfants::iterator it{ enfants_.begin() };
	it != enfants_.end();
		) {
		if ((*it)->obtenirType() == "rondelle") {
			NoeudAbstrait* enfant{ (*it) };
			enfants_.erase(it);
			delete enfant;
			it = enfants_.begin();
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudComposite::tuerMaillet()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudComposite::tuerMaillet()
{
	for (conteneur_enfants::iterator it{ enfants_.begin() };
	it != enfants_.end();
		) {
		if ((*it)->obtenirType() == "maillet") {
			NoeudAbstrait* enfant{ (*it) };
			enfants_.erase(it);
			delete enfant;
			it = enfants_.begin();
...
////////////////////////////////////////////////////////////////////////
///
/// @fn void NoeudComposite::tuerMailletOrdi()
///
...
///
////////////////////////////////////////////////////////////////////////
void NoeudComposite::tuerMailletOrdi()
{
	for (conteneur_enfants::iterator it{ enfants_.begin() };
	it != enfants_.end();
		) {
		if ((*it)->obtenirType() == "mailletOrdi") {
			NoeudAbstrait* enfant{ (*it) };
			enfants_.erase(it);
			delete enfant;
			it = enfants_.begin();
