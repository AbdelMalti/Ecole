...
namespace vue {
	...
	public:
		...
		Camera(const glm::dvec3& position,
			...
			const glm::dvec3& directionHautMonde/*, bool estOrbite*/);
		...
		/// Obtenir distance par rapport au centre
		double getDist() const;
		/// Modifier la distance par rapport au centre
		void setDist(double dist);
		/// Obtenir le mode de vue
		bool getEstOrbite() const;
		/// Modifier le mode de vue
		void setEstOrbite(bool estOrbite);
	...
	private:
		...
		double dist_;
		/// Angle de rotation dans le plan XY sur 360°
		double angleTetha_;
		/// Angle d'élevation entre Z et le plan XY sur 180°
		double anglePhi_;
		/// Vérifie si nous sommes en mode orbite
		bool estOrbite_;
	};
