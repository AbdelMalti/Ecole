...
namespace opengl{
	...
	public:
		...
		virtual void dessiner(bool estCouleur, bool estSelectionne, GLubyte couleur[], GLubyte couleurSelectionne[], const glm::mat4& transformation) const;
		virtual void dessiner(GLubyte couleur[], const glm::mat4& transformation) const;
	...
	private:
		...
		/// Dessin récursif
		void dessiner(modele::Noeud const& noeud, unsigned int& bufferIndex, bool estCouleur, bool estSelectionne, GLubyte couleur[], GLubyte couleurSelectionne[], const glm::mat4& vueProjection) const;
		void dessiner(modele::Noeud const& noeud, unsigned int& bufferIndex, GLubyte couleur[], const glm::mat4& transformation) const;
